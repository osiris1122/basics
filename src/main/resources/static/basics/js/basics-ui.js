    ...
    $.extend({
    	...
    	table: {
            ...
            init: function(options) {
                ...
                let _table=options.tableId||'bootstrap-table';
                let _toolbar=options.toolbarId||'toolbar';
          ...
          //资产
            myAsset: function(id) {
            	...
            	if ($.common.isNotEmpty(id)) {
            	    url = $.table._option.myAssetUrl.replace("{id}", id);
            	} else {
            	...
            	$.modal.open("资产" + $.table._option.modalName, url);
            },
            // 修改信息
            edit: function(id) {
            	var url = "/404.html";
