...
public class FileUploadUtils {
	 ...
	 *                                              比如读写文件出错时
	 */
	public static final String upload(String baseDir, MultipartFile file, String extension) throws FileSizeLimitExceededException, IOException, FileNameLengthLimitExceededException {
		...
		String url = "http://localhost/" + baseDir.substring(baseDir.indexOf("upload"), baseDir.length()) + fileName;
		File desc = getAbsoluteFile(baseDir, baseDir + fileName);
		file.transferTo(desc);
		return url;
	}

	public static final String uploadByte(String baseDir, byte[] bs, String extension) throws FileSizeLimitExceededException, IOException, FileNameLengthLimitExceededException {
