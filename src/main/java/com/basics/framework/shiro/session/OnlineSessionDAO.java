package com.basics.framework.shiro.session;
...
public class OnlineSessionDAO extends EnterpriseCacheSessionDAO
{
    ...
    {
        UserOnline userOnline = onlineService.getById(String.valueOf(sessionId));
        if (userOnline == null)
        {
            return null;
        }
    ...
    protected void doDelete(Session session)
    {
        ...
        onlineService.removeById(onlineSession.getUserId());
    }
}
